...
public class local_transport extends AppCompatActivity {
    Button buzz_btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_local_transport);
        dialog = new Dialog(this);

        buzz_btn = findViewById(R.id.buzz_btn_local);
    ...
    private void getPointss() {
        ...
        imageViewClose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dialog.dismiss();
                //Toast.makeText(local_transport.this, "Dialog Close",Toast.LENGTH_SHORT).show();
            }
        });
        ...
        btnOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dialog.dismiss();
                //Toast.makeText(local_transport.this, "Button OK",Toast.LENGTH_SHORT).show();
            }
        });
