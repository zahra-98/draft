...
public class reuse_bag extends AppCompatActivity {
    Button buzz_btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buzz_btn = findViewById(R.id.buzz_btn_reuse);
    ...
    private void getPointss() {
        ...
        imageViewClose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dialog.dismiss();
                //Toast.makeText(reuse_bag.this, "Dialog Close",Toast.LENGTH_SHORT).show();
            }
        });
        ...
        btnOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dialog.dismiss();
                //Toast.makeText(reuse_bag.this, "Button OK",Toast.LENGTH_SHORT).show();
            }
        });
...
//
//
//                String get = snapshot.child("points").getValue().toString();
//                int sum = Integer.parseInt(get);
//                point = point + sum;
//                databaseReference.setValue(sum).toString();
//
//
//
//            }
